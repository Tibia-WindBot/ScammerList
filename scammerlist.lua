SCAM_LIST = {
	...
	{name = "-", contact = "email: leicer131@gmail.com", nicks = "Leicer", reasons = "Tried to falsificate moderator account to vouch for scam"},
}
